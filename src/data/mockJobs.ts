...
export const mockJobs: Job[] = [
  ...
  },
  {
    ...
    posted_date: new Date(Date.now() - 8 * 60 * 60 * 1000).toISOString(),
  ...
  },
  {
    ...
    posted_date: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(),
  ...
  },
  {
    ...
    posted_date: new Date(Date.now() - 18 * 60 * 60 * 1000).toISOString(),
